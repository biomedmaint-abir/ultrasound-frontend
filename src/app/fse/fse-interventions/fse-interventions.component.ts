...
<div class="page-container">
  ...
  <div class="filter-card">
    <div class="search-wrap">
      <span>🔍</span>
      <input type="text" [(ngModel)]="search" (input)="applyFilter()" placeholder="Rechercher par équipement ou site..." class="search-input">
    </div>
...
.btn-voir:hover{background:#0d1bb5}
.validation-label{font-size:12px;color:#7C3AED;font-weight:600}
.done-label{font-size:12px;color:#16A34A;font-weight:600}
