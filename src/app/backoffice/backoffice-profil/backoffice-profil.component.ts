...
@Component({
  selector: 'app-backoffice-profil',
  standalone: true,
...
<div class="page-container">
  <div class="profil-header">
    ...
    <div><h1>Mon Profil</h1><p>{{ email }}</p><span class="role-badge">Back-office</span></div>
  </div>
  <div class="profil-card">
    ...
    <div class="form-grid">
      ...
      <div class="form-group"><label>Nouveau mot de passe</label><input type="password" [(ngModel)]="newPassword" placeholder="Laisser vide" class="form-input"></div>
    </div>
...
.profil-header{display:flex;align-items:center;gap:16px;margin-bottom:28px;.avatar{width:64px;height:64px;border-radius:50%;background:#f97316;color:white;font-size:24px;font-weight:800;display:flex;align-items:center;justify-content:center}h1{margin:0;font-size:26px;font-weight:800;color:#0d1340}p{margin:4px 0;font-size:13px;color:#6b7280}.role-badge{display:inline-block;padding:4px 12px;border-radius:20px;background:#FFF7ED;color:#f97316;font-size:12px;font-weight:600}}
...
.btn-save{background:#f97316;color:white;border:none;border-radius:10px;padding:12px 24px;font-size:14px;font-weight:600;cursor:pointer}
...
export class BackofficeProfilComponent implements OnInit {
