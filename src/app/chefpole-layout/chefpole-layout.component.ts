    ...
    <div class="sidebar-footer">
      <div class="user-card">
        ...
        <div class="user-details">
          ...
          <span class="user-role">Chef de pôle</span>
        </div>
      </div>
...
.logo{display:flex;align-items:center;gap:10px;.logo-icon-box{width:36px;height:36px;background:#F0FDF4;border-radius:10px;display:flex;align-items:center;justify-content:center;font-size:18px}.logo-texts{display:flex;flex-direction:column}.logo-text{color:#1C2B5A;font-size:16px;font-weight:800}.logo-sub{font-size:10px;color:#6b7280;font-style:italic}}
...
.nav-item{display:flex;align-items:center;gap:12px;padding:11px 14px;border-radius:10px;color:#6b7280;text-decoration:none;transition:all .2s ease;position:relative;.nav-icon{font-size:18px;flex-shrink:0}.nav-label{font-size:13.5px;font-weight:500;white-space:nowrap}&:hover{background:#f8f9fc;color:#0d1340}&.active{background:#F0FDF4;color:#16A34A;.nav-label{font-weight:700}&::before{content:'';position:absolute;left:0;top:50%;transform:translateY(-50%);width:3px;height:24px;background:#16A34A;border-radius:0 4px 4px 0}}}
.sidebar-footer{padding:12px 8px;border-top:1px solid #f1f3f5;display:flex;flex-direction:column;gap:6px}
.user-card{display:flex;align-items:center;gap:10px;padding:10px 12px;border-radius:10px;background:#f8f9fc;.user-avatar{width:36px;height:36px;border-radius:50%;background:#16A34A;color:white;display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:700;flex-shrink:0}.user-details{flex:1;min-width:0;.user-email{display:block;font-size:12px;font-weight:600;color:#0d1340;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.user-role{display:block;font-size:11px;color:#16A34A;font-weight:600}}}
...
export class ChefPoleLayoutComponent {
